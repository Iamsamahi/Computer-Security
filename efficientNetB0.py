...
print("Classification report saved to classification_report_efficientNetB0.csv")
...
plt.savefig("training_history_efficientNetB0.png")
plt.show()

# Save Model
model.save("efficientNetB0_without_augmentation.h5")
