...
IMG_SIZE = (224, 224)
EPOCHS = 20
DATASET_DIR = "Processed_Datasetataset"
...
report_df.to_csv("classification_report_inceptionv3.csv", index=True)
print("Classification report saved to classification_report_inceptionv3.csv")
...
# Save Model
model.save("inceptionv3_without_augmentation.h5")
